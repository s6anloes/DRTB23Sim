...
class DRTB23SimSignalHelper {
	...
	const G4double fSAttenuationLength = 99999999191.6*CLHEP::cm; // from test beam data
	const G4double fCAttenuationLength = 99999999388.9*CLHEP::cm; // from test beam data
